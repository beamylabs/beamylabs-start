...
_FILEUPLOADREQUEST.fields_by_name['fileDescription'].message_type = common__pb2._FILEDESCRIPTION
...
_FILEUPLOADCHUNKREQUEST.fields_by_name['fileDescription'].message_type = common__pb2._FILEDESCRIPTION
...
_FILEDOWNLOADRESPONSE.fields_by_name['fileDescription'].message_type = common__pb2._FILEDESCRIPTION
...
_SYSTEMSERVICE = _descriptor.ServiceDescriptor(
  ...
  _descriptor.MethodDescriptor(
    ...
    index=4,
    containing_service=None,
    input_type=common__pb2._FILEDESCRIPTION,
