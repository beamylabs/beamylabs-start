 ...
 * @return {!proto.base.SenderInfo} returns this
*/
...
proto.base.SubscriberRequest.toObject = function(includeInstance, msg) {
  var f, obj = {
    clientid: (f = msg.getClientid()) && common_pb.ClientId.toObject(includeInstance, f),
    onchange: jspb.Message.getBooleanFieldWithDefault(msg, 2, false)
  };
...
/**
 * @param {?proto.base.ClientId|undefined} value
 * @return {!proto.base.SubscriberRequest} returns this
*/
...
/**
 * @param {number} value
 * @return {!proto.base.Value} returns this
 */
